...
const translations = {
  en: {
    ...
    voiceFirstTitle: 'Voice Experience',
    startVoiceExperience: 'Start Voice Experience',
    voiceFirstDesc: 'Navigate entirely by voice. Ask questions, browse topics, and hear content read aloud — no reading required.',
    exitVoiceMode: 'Exit Voice Mode',
    voiceGreeting: 'Welcome to the voice experience. You can say things like "show me the topics", "go to WCAG", "read this page", or ask any question about accessibility. Say "help" at any time for guidance.',
    voiceGreetingShort: 'Voice mode active. How can I help?',
    voiceHelp: 'You can say: "list topics" to hear available topics, "go to" followed by a topic name to navigate, "read the page" or "read the summary" to hear the current content, "where am I" to know your location, "go back" to return to topics, or just ask any question about accessibility.',
    voiceNavigating: 'Navigating to',
    voiceNowOn: 'You are now on',
    voiceWouldYouLike: 'Would you like me to read the page, the summary, or ask a question?',
    voiceListTopicsIntro: 'Here are the available topics:',
    voiceWhereAmI: 'You are currently on',
    voiceOnHome: 'You are on the home page.',
    voiceOnTopics: 'You are on the topics list page.',
    voiceGoingBack: 'Going back to the topics list.',
    voiceGoingHome: 'Going to the home page.',
    voiceStopping: 'Stopped.',
    voiceClassifying: 'Processing...',
    voiceListening: 'Listening...',
    voiceThinking: 'Thinking...',
    voiceSpeaking: 'Speaking...',
    voiceReading: 'Reading...',
    voiceNavError: 'Something went wrong. Please try again.',
    voiceNoPage: 'There is no page content to read right now. Try navigating to a topic first.',
  ...
  es: {
    ...
    // Voice-first navigation mode
    voiceFirstTitle: 'Experiencia de Voz',
    startVoiceExperience: 'Iniciar Experiencia de Voz',
    voiceFirstDesc: 'Navegue completamente por voz. Haga preguntas, explore temas y escuche el contenido en voz alta — sin necesidad de leer.',
    exitVoiceMode: 'Salir del Modo de Voz',
    voiceGreeting: 'Bienvenido a la experiencia de voz. Puede decir cosas como "muéstrame los temas", "ir a WCAG", "leer esta página", o hacer cualquier pregunta sobre accesibilidad. Diga "ayuda" en cualquier momento para orientación.',
    voiceGreetingShort: 'Modo de voz activo. ¿Cómo puedo ayudar?',
    voiceHelp: 'Puede decir: "listar temas" para escuchar los temas disponibles, "ir a" seguido de un nombre de tema para navegar, "leer la página" o "leer el resumen" para escuchar el contenido actual, "dónde estoy" para saber su ubicación, "volver" para regresar a los temas, o simplemente hacer cualquier pregunta sobre accesibilidad.',
    voiceNavigating: 'Navegando a',
    voiceNowOn: 'Ahora está en',
    voiceWouldYouLike: '¿Le gustaría que lea la página, el resumen, o hacer una pregunta?',
    voiceListTopicsIntro: 'Estos son los temas disponibles:',
    voiceWhereAmI: 'Actualmente está en',
    voiceOnHome: 'Está en la página de inicio.',
    voiceOnTopics: 'Está en la página de lista de temas.',
    voiceGoingBack: 'Volviendo a la lista de temas.',
    voiceGoingHome: 'Yendo a la página de inicio.',
    voiceStopping: 'Detenido.',
    voiceClassifying: 'Procesando...',
    voiceListening: 'Escuchando...',
    voiceThinking: 'Pensando...',
    voiceSpeaking: 'Hablando...',
    voiceReading: 'Leyendo...',
    voiceNavError: 'Algo salió mal. Inténtelo de nuevo.',
    voiceNoPage: 'No hay contenido de página para leer ahora. Intente navegar a un tema primero.',
    tapToSpeak: 'Toque para hablar',
    tapToStop: 'Toque para detener',
